...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="block clearfix" style="position: relative; height: 98px;">
            <a href="#" name="top">
                <img class="logo" src="<?php echo PUBLIC_PATH ?>/images/logo.gif">
            </a>
        ...
        <div class="header_bg">
            ...
            <form id="searchForm" method="get" >
                ...
                <input name="imageField" value=" " class="go" style="cursor: pointer; background: url('<?php echo PUBLIC_PATH ?>/images/sousuo.gif') no-repeat scroll 0% 0% transparent; width: 39px; height: 20px; border: medium none; float: left; margin-right: 15px; vertical-align: middle;" type="submit">
        ...
        <div class="header_bg_b">
            <div class="f_l" style="padding-left: 10px;">
                <img src="<?php echo PUBLIC_PATH ?>/images/biao6.gif">
                    北京市区，现在下单(截至次日00:30已出库)，<b>明天上午(9-14点)</b>送达 <b>免运费火热进行中！</b>
            </div>

            <div class="f_r" style="padding-right: 10px;">
                <img style="vertical-align: middle;" src="<?php echo PUBLIC_PATH ?>/images/biao3.gif">

                    <span class="cart" id="ECS_CARTINFO">
                        <a href="#" title="查看购物车">您的购物车中有 0 件商品，总计金额 ￥0.00元。</a></span>
                    <a href="#"><img style="vertical-align: middle;" src="<?php echo PUBLIC_PATH ?>/images/biao7.gif"></a>
            </div>
        </div>
        ...
        <div class="block block1">
            ...
            <div class="usBox clearfix">
                            ...
                            <tbody><tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <input name="back_act" value="<?php echo PUBLIC_PATH ?>/index.php" type="hidden" />
                ...
                <div class="usTxt">
                    ...
                    <div style="padding-left: 50px;">
                        ...
                        3. 享受会员积分制度<br />
                        4. 订阅本店商品信息  <br />
                        <a href="#"><img src="<?php echo PUBLIC_PATH ?>/images/bnt_ur_reg.gif"></a>
                    </div>
                </div>
            </div>
            </div>
            ...
            <div class="blank"></div>
            <div class="block">
                <a href="#" target="_blank" title="YONGDA商城"><img alt="YONGDA商城" src="<?php echo PUBLIC_PATH ?>/images/di.jpg"></a>
            ...
            <div id="bottomNav" class="box block">
                <div class="box_1">
                    <div class="links clearfix"> 
                        <a href="#" target="_blank" title="YONGDA商城"><img src="<?php echo PUBLIC_PATH ?>/images/logo.gif" alt="YONGDA商城" border="0"></a>
