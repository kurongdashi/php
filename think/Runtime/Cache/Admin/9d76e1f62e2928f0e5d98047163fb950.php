...
<html>
    ...
    <body>
        <table height="100%" cellspacing=0 cellpadding=0 width=170 
               background={$smarty.const.ADMIN_PUBLIC_PATH}/img/menu_bg.jpg border=0>
               <tr>
                <td valign=top align=middle>
                    ...
                    <table cellspacing=0 cellpadding=0 width=150 border=0>
                        ...
                        <tr height=22>
                            <td style="padding-left: 30px" background={$smarty.const.ADMIN_PUBLIC_PATH}/img/menu_bt.jpg><a 
                    ...
                    <table id=child1 style="display: none" cellspacing=0 cellpadding=0 
                        ...
                        <tr height=20>
                            <td align=middle width=30><img height=9 
                                                           src="{$smarty.const.ADMIN_PUBLIC_PATH}/img/menu_icon.gif" width=9></td>
                    ...
                    <table id=child3 style="display: none" cellspacing=0 cellpadding=0 
                        ...
                        <tr height=20>
                            <td align=middle width=30><img height=9 
                                                           src="{$smarty.const.ADMIN_PUBLIC_PATH}/img/menu_icon.gif" width=9></td>
                            <td><a class=menuchild 
                                   href="/think/index.php/Admin/Goods/showlist" 
                                   
                                   target='right'>产品展示</a></td></tr>
                        <!--target: _blank/_self/_top/frame的name属性值，覆盖frame一块-->
                        <tr height=20>
                            <td align=middle width=30><img height=9 
                                                           src="{$smarty.const.ADMIN_PUBLIC_PATH}/img/menu_icon.gif" width=9></td>
                            <td><a class=menuchild 
