...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="{$smarty.const.ADMIN_PUBLIC_PATH}/css/User_Login.css" type="text/css" rel="stylesheet" />
                    ...
                    <form action="#" method="post">
                        <ul>
                                ...
                                <div class="user_main_box">
                                    ...
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            ...
                                            <img src="{$smarty.const.ADMIN_PUBLIC_PATH}/img/admin.png"  alt="" />
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="user_main_r">
                                ...
                                <input style="border: medium none; background: url('{$smarty.const.ADMIN_PUBLIC_PATH}/img/user_botton.gif') repeat-x scroll left top transparent; height: 122px; width: 111px; display: block; cursor: pointer;" value="" type="submit">
                            </li>
                        </ul>
                    </form>
